...
/**
 * @file Goalie.java Class file for Goalie class
 * @author Joel Tanzi
 * @date 11 October 2011
 * @version 1.3
 */
/**
 * @class Goalie The Goalie class inherits from the Player class. The Goalie is
 * a specialized type of Player that may catch the ball under certain conditions
 * and defends the goal from the opposing team.
 */
public class Goalie extends Player {
    ...
    public void defendGoal(ObjBall ball) throws UnknownHostException, InterruptedException {
        ...
        if (ball.getDistance() > 1.0) {
            ...
            //Thread.sleep(100);
        } else if ((getMem().side.compareTo("l") == 0) && ((getMem().playMode.compareTo("goalie catch ball_l") == 0) || (getMem().playMode.compareTo("free_kick_l") == 0))) {
            Thread.sleep(500);
