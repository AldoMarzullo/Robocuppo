...
/**
 * @file RoboClient.java Class file for RoboClient class
 * @author Joel Tanzi
 * @date September 20, 2011
 * @version 1.2
 */
/**
 * @class RoboClient The RoboClient class operates as a client for the RoboCup
 * session. It is mainly designed to be used by the Player class to handle all
...
public class RoboClient {
    ...
    /**
     * This function reads in a message string, and sends it to the RoboCup
     * server. It primarily serves as a method to send commands to the server to
     * control server and player actions.
     *
    ...
    /**
     * This function receives a UDP packet from the RoboCup server, and converts
     * it to a String.
     *
     ...
     * @pre The RoboCup server is available, team has been initialized.
     * @post The player has turned the given number of degrees from original
     * orientation.
     * @return None
     */
    ...
    /**
     * This function causes the active player to be teleported to a given set of
     * coordinates within the soccer field.
     *
     * @param x: an integer value for the x-coordinate to move to.
     * @param y: an integer value for the y-coordinate to move to.
     * @pre The RoboCup server is available, team has been initialized, kickoff
    ...
    /**
     * This function causes the active player to catch the ball. It can only be
     * used by a Goalie type player.
     *
     * @param d An integer value representing the direction from which to catch
     * the ball.
     ...
     *
     * @param message A string representing the message to be spoken by the
     * player.
     * @pre None
